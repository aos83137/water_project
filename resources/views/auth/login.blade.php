        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="logo-container">
                    <img src="{{ asset('assets/img/cup-logo.png') }}" alt="">
                </div>
                <h4 class="text-white">{{ __('1시간 한잔 하루에 2L') }}</h4>
                </div>
                <div class="card-body ">
                ...
                <button  type = "submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('로그인') }}</button>
                <div class="pull-left">
                    <h6>
                    <a href="{{ route('register') }}" class="link footer-link">{{ __('회원가입') }}</a>
                    </h6>
                </div>
                <div class="pull-right">
                    <h6>
                    <a href="{{ route('password.request') }}" class="link footer-link">{{ __('비밀번호를 잊으셨나요??') }}</a>
                    </h6>                
                </div>
                </div>
            </div>
